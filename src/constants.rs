    ...
    pub const COLORS_AVAILABLE :       usize = 7;
    pub const COLORS: [&'static druid::Color; COLORS_AVAILABLE] =
        [   
            &Color::AQUA, 
            &Color::RED, 
            &Color::FUCHSIA, 
    ...
    "\n  eeBook Reader©\n
    Welcome to our Epub Reader. This application, developed in Rust language in collaboration with the Politecnico di Torino,
    allows you to read your digital books in epub format. In addition to reading and searching for chapters, the application
    authorizes the user to edit their books and save them. Also, you can search for the first occurrence of a given string.
    The implementation of OCR involves the management of two buttons:
        ...
        - 🖼️ ➜ Starting from a digital page it is possible to view the photo relating to the book page if this has been
                     previously recognized and/or estimate the page number of the paper version.\n\n
